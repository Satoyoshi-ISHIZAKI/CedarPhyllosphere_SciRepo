...
p_pc1pc1 <- ggplot(data = data_pca, mapping = aes(x = PC1_clim, y = PC1, color = population)) +
  geom_smooth(method = "lm", color = "black", linewidth = .352777778, alpha = 0.1) +
  geom_point() +
...
p_lm <- grid.arrange(pl_pc1pc1, pl_pc1pc2, pl_pc2pc1, pl_pc2pc2, 
                     nrow = 2)

ggsave(plot = p_lm, filename = paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/figures/LM_terpene_climate.png"), 
