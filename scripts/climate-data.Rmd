...
```{r}
#theme settings
mytheme <-theme(axis.title = element_text(size = 7 * 9/4),
                axis.text = element_text(size = 6 * 9/4),
                axis.line = element_line(linewidth = .352777778 * 9/4), 
                
                legend.title = element_text(size = 7 * 9/4), 
                legend.text = element_text(size = 6 * 9/4), 
                legend.key.size = unit(8 * 9/4, "pt"), 
...
p_pca <- autoplot(pca_pl, 
                  ...
                  label.size = 7 * .352777778 * 9/4,
                  color = "latitude",
                  loadings = TRUE,
                  loadings.color = "grey",
                  loadings.linewidth = 2 * .352777778 * 9/4,
                  loadings.label = TRUE,
                  loadings.label.size = 6 * .352777778 * 9/4) +
  coord_fixed(ratio = 1) +
  theme_classic() +
  labs(color = "Latitude") +
  mytheme
...
p_pca2 <- autoplot(pca_pl,
                  ...
                  loadings = TRUE,
                  loadings.color = "grey",
                  loadings.linewidth = .352777778 * 9/4,
                  loadings.label = TRUE,
                  loadings.label.size = 6 * .352777778 * 9/4) +
  coord_fixed(ratio = 1) +
  theme_classic() +
