...
p_pca <- ggplot(data = pldata, mapping = aes(x = PC1, y = PC2, color = latitude)) +
  geom_text(aes(label = population), size = 10 * .352777778) +
  geom_segment(data = pca_pl$rotation, 
               aes(x = 0, y = 0, xend = PC1*1.85, yend = PC2*1.85), 
               arrow = arrow(length = unit(0.2, "cm")),
               color = "grey", linewidth = 3 * .352777778) +
  coord_fixed(ratio = 1) +
  theme_classic(base_size = 12) +
  labs(color = "Latitude") +
  mytheme +
