...
p_all <- grid.arrange(pl_16S_k, pl_16S_t, pl_ITS_k, pl_ITS_t, 
                          nrow = 2, ncol = 2)
...
ggsave(p_all, filename = paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/figures/barplot_both.png"), 
       dpi = 400, width = 120, height = 160, units = "mm", scale = 2)
```

```{r}
legend <- grid.arrange(legend_16S, legend_ITS, nrow = 2, ncol = 1)
...
ggsave(legend, filename = paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/figures/barplot_legend_both.png"), 
       dpi = 400, width = 120, height = 160, units = "mm")
```
