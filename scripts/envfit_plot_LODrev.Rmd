...
load(file = paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/analysis/envfit_bray_BVOC_LODrev.Rdata"))
...
#output of vector-fitting (BVOC on NMDS based on bray)
load(file = paste0(path_out, "/231202_Sugi_phyllosphere_June_ITS/analysis/envfit_bray_BVOC_LODrev.Rdata"))
...
score_16S <- data.frame(score_16S, 
                        ...
                        arr_col = rep("green4", nrow(score_16S)), 
                        arr_lty = rep("dashed", nrow(score_16S)))
score_16S$arr_col[score_16S$rowname == "total"] <- "black"
...
score_ITS <- data.frame(score_ITS, 
                        ...
                        arr_col = rep("blue3", nrow(score_ITS)), 
                        arr_lty = rep("dashed", nrow(score_ITS)))
score_ITS$arr_col[score_ITS$p < 0.05] <- "blue3"
...
show(p_16S)
ggsave(plot = p_16S, filename = paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/figures/envfit_BVOC_ASV_log_LODrev.png"), 
...
show(p_ITS)
ggsave(plot = p_ITS, filename = paste0(path_out, "/231202_Sugi_phyllosphere_June_ITS/figures/envfit_BVOC_ASV_log_LODrev.png"), 
       dpi = 300, width = 160, height = 160, units = "mm")
```
...
ggsave(p_two_fit, filename = paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/figures/envfit_BVOC_ASV_log_LODrev_both1.pdf"), 
