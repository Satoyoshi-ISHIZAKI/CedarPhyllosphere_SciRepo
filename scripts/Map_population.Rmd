...
<details><summary>Map of the population locations</summary>
...
show(map_noleg)
ggsave(plot = map_noleg, filename = paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/figures/population_map_noleg.png"), 
       width = 160, height = 130, units = "mm", dpi = 300)
```
