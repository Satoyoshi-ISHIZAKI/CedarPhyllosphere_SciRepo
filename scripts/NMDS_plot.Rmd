...
p_16S_ASV <- p_16S_ASV + geom_text(aes(label = names(pop_num))#, size = 6
                                   )
...
#stress value
p_16S_ASV <- p_16S_ASV + annotate("text", x = 1.35, y = -2, #size = 6,
                                  label = paste0("stress = ", 
                                                 round(nmds_16S$nmds$stress, digits = 4)))
...
p_two_bray_ASV <- grid.arrange(p_16S_ASV, p_ITS_ASV, nrow = 1)
