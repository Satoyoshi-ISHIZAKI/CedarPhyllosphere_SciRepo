...
#omit the unused samples (microbial samples were not collected for them)
#omit AJ_002_1 and AZ_002_1
"%not.in%" <- Negate("%in%")
BVOC_tbl <- BVOC_tbl %>%
  dplyr::filter(Samplename %not.in% c("AZ_002_01", "AJ_002_01"))
...
gtsave(BVOC_tbl, file = paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/export/BVOC_BE_LODrev_2.png"), 
       vwidth = 2362, vheight = 1323)
gtsave(BVOC_tbl, file = paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/export/BVOC_BE_LODrev_2.pdf"), 
       vwidth = 2362, vheight = 1323)
```
