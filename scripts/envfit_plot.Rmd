...
signif_16S_ASV$adj_x <- c(0.5, 0.1, 0, -0.3, 0.3, 0.5, 0, 0)
...
signif_ITS_ASV$adj_x <- c(0.35, 0, 0, 0, -0.32)
signif_ITS_ASV$adj_y <- c(0, -0.05, -0.13, -0.02, 0)
```
...
p_16S <- ggplot(df_nmds_16S, mapping = aes(x = MDS1, y = MDS2)) +
  ...
  geom_text(data = signif_16S, size = 6 * .352777778, 
  ...
  #stress value
  annotate("text", 
           x = 1.65, y = -1.05, size = 7 * .352777778, 
           label = paste0("Stress = ", 
...
p_ITS <- ggplot(df_nmds_ITS, mapping = aes(x = MDS1, y = MDS2)) +
  ...
  geom_text(data = signif_ITS, 
            ...
            color = "purple3", size = 6 * .352777778, parse = TRUE) +
  
  #annotation to show the stress value
  annotate("text", 
           x = 0.7, y = -1.15, size = 7 * .352777778, 
           label = paste0("Stress = ", 
