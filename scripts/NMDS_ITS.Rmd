...
#save(nmds_bray, file = paste0(path_out, "/231202_Sugi_phyllosphere_June_ITS/processed_data/NMDS_bray_ITS.Rdata"))
```
...
nmds_UF$nmds$stress
#save(nmds_UF, file = paste0(path_out, "/231202_Sugi_phyllosphere_June_ITS/processed_data/NMDS_weightedUF_ITS.Rdata"))
```
...
p_nmds <- p_nmds + theme(legend.position = "none", 
                         text = element_text(size = 15, family="sans"))
p_nmds
ggsave(filename = paste0(path_out, "/231202_Sugi_phyllosphere_June_ITS/figures/NMDS_UF_wide.png"), 
       plot = p_nmds, dpi = 400, width = 150, height = 150, units = "mm")
```
...
save(nmds_unUF, file = paste0(path_out, "/231202_Sugi_phyllosphere_June_ITS/processed_data/NMDS_unweightedUF_ITS.Rdata"))
```
