...
otu_16S <- read.csv(paste0(path_out, "/231202_Sugi_phyllosphere_June_16S/processed_data/otus_data_16S.csv"), row.names = 1)
rownames(otu_16S) <- formatC(as.numeric(rownames(otu_16S)), width = 4, flag = "0")
...
```{r}
ps_16S <- phyloseq(otu_table(t(df_rarefied), taxa_are_rows = TRUE), 
               tax_table(tax_table), 
